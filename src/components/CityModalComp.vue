...
<template>
  ...
  >
    <div
      class="max-w-[600px] w-full p-10 rounded-[5px] bg-[var(--primary-color)]"
      @click.stop
    >
      <div class="flex justify-between">
        <h2 class="text-2xl text-[var(--cta-color)]">
      ...
      <ul class="border border-[var(--cta-color)] mt-5">
        <li
          ...
          :key="nearbyCity.id"
          class="odd:bg-[var(--ter-color)] px-3 py-2 flex justify-between"
        >
